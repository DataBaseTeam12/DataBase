	...
	<div class="container">
		...
		<header>
			...
			<div class="subhead">
				...
				{
				    echo"<form action='http://databaseteam12.x10host.com/login/logout.php' style='width: 64px; float: right;'>
					<button>Logout</button>
				</form>";
				}else{
				    
				  echo"  <form action='http://databaseteam12.x10host.com/login/login.php' style='width: 64px; float: right;'>
					<button>Login</button>
				</form>
