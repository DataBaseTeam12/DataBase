...
<head>
	<title>Laptops by End Date</title>
...
<body>
	...
	<main>
		...
		$sql = "SELECT * FROM Laptop_Rents WHERE returned_date IS NULL ORDER BY end_date ASC;";
		$result = $conn->query($sql);
		
		// If result is not empty, display it
		if ($result->num_rows > 0) {
			echo "<table><tr><th width='15%'>Laptop ID</th><th width='25%'>Serial Number</th>
			<th width='40%'>Reserved Date Range</th><th width='20%'>Member ID</th></tr>";
