		...
		if ($rtype == "checked-out") {
			...
			switch ($dtype) {
				...
				case "year":
					...
					break;
				case "":
					$sql = "SELECT * FROM Media_Borrows";
					echo "</h2><hr><div style=\"padding: 15px; background-color: #f44336; color: white;\">
						Select a date range.</div>"; 
					break;
			}
			...
			switch ($dtype) {
				...
				case "year":
					...
					break;
				case "":
					$sql = "SELECT * FROM Media_Reserves";
					echo "</h2><hr><div style=\"padding: 15px; background-color: #f44336; color: white;\">
						Select a date range.</div>"; 
					break;
			}
